    ...
    <div data-aos="fade-right" id="about" className="flex gap-8 flex-wrap">
      ...
      <div className="flex-1 flex items-center justify-center min-w-[280px] md:min-w-[420px]">
        <p className="text-lg leading-10 font-medium">
          ...
          me conectar com minha essência e transmitir emoções através do meu
          olhar e gestos. Minha personalidade autêntica se reflete em cada
          imagem, e estou sempre pronta para novos desafios e oportunidades. Se
          busca uma modelo autêntica e cheia de energia para criar imagens
          inspiradoras, estou aqui para embarcar nessa jornada com você.
        </p>
      </div>
    </div>
  );
